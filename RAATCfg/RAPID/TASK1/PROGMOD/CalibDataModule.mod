MODULE CalibDataModule
    ...
    TASK PERS wobjdata wobjCurrent:=[FALSE,TRUE,"",[[-2155,0,60],[1,0,0,0]],[[15.6188,-22.739,10.978],[1,0,0,0]]];
    ...
    TASK PERS jointtarget jointCurrent:=[[0.0001963,-59.9989,39.9983,0.000305577,59.9961,7.30056E-05],[578.229,14.3149,-499.998,9E+09,9E+09,9E+09]];
