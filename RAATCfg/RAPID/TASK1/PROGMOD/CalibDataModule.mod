MODULE CalibDataModule
    ...
    TASK PERS wobjdata wobjCurrent:=[FALSE,TRUE,"",[[-480,0,60],[1,0,0,0]],[[2.32418,12.902,22.9621],[1,0,0,0]]];
    ...
    TASK PERS jointtarget jointHome:=[[0,-60,40,0,60,0],[-1300,500,-500,9E+09,9E+09,9E+09]];
    ...
    TASK PERS jointtarget jointHomeOld:=[[0,-60,40,0,60,0],[-1250.64,452.053,-500,9E+09,9E+09,9E+09]];
